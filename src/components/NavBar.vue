<template>
    <nav class="naviBar">
        <ul class="naviBar-nav">
            ...
            <li class="nav-item">
            <a href="#contact-section" class="navi-link">
